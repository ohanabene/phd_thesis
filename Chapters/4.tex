...
On cluster finding, the algorithm works to isolate groups of hits in each of the planes. It veto hits in or nearby a configurable distance of a Pandora-identified track. Figure \ref{blip_track_veto} illustrates that procedure. Next, it individually clusters the left-over hits in each wire plane. 
