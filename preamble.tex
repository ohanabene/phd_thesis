...
\newcommand{\capa}{\begin{titlepage}
  ...
  {\Large \author}\par
  \vspace{1cm}
  {\small B.S., State University of Campinas, 2015}\\
  {\small M.S., Federal University of Goi\'as, 2018}\\[\baselineskip]
  {\small \type \\ submitted in partial fulfillment of the requirements for the degree of}\\
  {\small\itshape \degree in Physics}\\[\baselineskip]
  %{\scshape \course}\\
  %{\scshape \college}\\
  %{\scshape \university}\\
  {\small\scshape December \year}\par
  \vfill
  {\hfill Approved: \underline{\hspace{4cm}}\\
   \hfill Mitchell Soderberg~~~~\\
   \hfill\\
   \hfill Date: \underline{\hspace{4cm}}
  }\\[\baselineskip]
  \vfill
  \end{titlepage}%
  %\verso
...
\newcommand{\paginaTECA}{\begingroup
  ...
  \centering
  \vspace*{\fill}
  {\Large Copyright $\copyright$ Ohana Benevides Rodrigues \\ Doctor of Philosophy in Physics \\ 2022 \\ All Rights Reserved \\ }
  \vspace*{\fill}
  \endgroup
  \newpage
}
...
\newcommand{\notaagradecimentoingles}{\chapter*{Acknowledgements}
  \addcontentsline{toc}{chapter}{\protect\numberline{}Acknowledgements}
  \pagenumbering{roman}
  %\setcounter{page}{9}
  \the\agradecimentoingles
}

\newcommand{\notaagradecimento}{\chapter*{Agradecimentos}
